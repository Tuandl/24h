                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="section comment">
                                    ...
                                    <c:forEach items="${requestScope.COMMENT-LIST}" var="comment">
                                        <c:choose>
                                            <c:when test="${comment.status eq 'Available'}">
                                                <div class="media comment-hidden">
                                                    ...
                                                    <div class="media-body">
                                                        <h4 class="media-heading"> ${comment.creatorID} <small><i>${comment.lastStatusChangedTime}</i></small></h4>
                                                        <p>${comment.content}</p>
                                                    </div>
                                                </div>
                                            </c:when>
