<%-- 
    Document   : multi-pagination
    Created on : Oct 30, 2017, 12:46:59 PM
...
<ul class="pagination pagination-success">
    <c:choose>
        ...
        <c:otherwise>
            <li>
                <a href="${param.baseURL}${param.pageParam}=${param.curPage}"><</a>
            </li>
        </c:otherwise>
    </c:choose>
    <%
    ...
    <li class="active"><a><%=i+1%></a></li>
            ...
            %>
    <li><a href="${param.baseURL}${param.pageParam}=<%=i+1%>"><%=i+1%></a></li>
        <%
                }
            }
        %>
        ...
        <c:otherwise>
            <li>
                <a href="${param.baseURL}${param.pageParam}=${param.curPage + 2}">></a>
            </li>
        </c:otherwise>
    </c:choose>
</ul>