...
/**
 * This filter is for config the comment of the article: 
 ...
 */
@WebFilter(filterName = "AreticlePageFilter", urlPatterns = {"/tuanda/article.jsp"}, 
...
public class ArticlePageFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("ReadArticleFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ReadArticleFilter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("ReadArticleFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("ReadArticleFilter()");
        }
        StringBuffer sb = new StringBuffer("ReadArticleFilter(");
