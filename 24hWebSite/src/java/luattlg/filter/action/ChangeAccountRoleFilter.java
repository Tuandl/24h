...
public class ChangeAccountRoleFilter implements Filter {
    ...
    public ChangeAccountRoleFilter() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ChangeAccountRoleFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ChangeAccountRoleFilter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("ChangeAccountRoleFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("ChangeAccountRoleFilter()");
        }
        StringBuffer sb = new StringBuffer("ChangeAccountRoleFilter(");
