 ...
 */
@WebFilter(filterName = "GeneralFilter", urlPatterns = {"/*"},dispatcherTypes = {DispatcherType.FORWARD,DispatcherType.INCLUDE,DispatcherType.REQUEST})
public class GeneralFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
            ...
            if(listOfRole == null){
                String isInit = (String)request.getAttribute("IS-INIT");
                if(isInit == null){
                    isInit = "YES";
